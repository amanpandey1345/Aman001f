...
export const updateProfile = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(`${server}/api/v1/`, userData, config);
...
export const getBetUser =() => async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(`${server}/api/v1/mybet`);
...
export const getDepositUser =() => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${server}/api/v1/mydeposit`);
  ...
  export const getWithdrawalUser =() => async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(`${server}/api/v1/mywithdrawal`);
...
export const getAllBets = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${server}/api/v1/admin/bets`);
...
export const getAllDeposits = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${server}/api/v1/admin/deposits`);
...
export const getAllWithdrawals = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${server}/api/v1/admin/withdrawals`);
...
export const AdminUpdateUser1 = (id, userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`${server}/api/v1/admin/user/update/${id}`, userData, config);
...
export const AdminUpdateWith1 = (id, userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`${server}/api/v1/admin/withdrawals/update/${id}`, userData, config);
...
export const AdminUpdateDeposit1 = (id, userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`${server}/api/v1/admin/deposits/update/${id}`, userData, config);
...
export const AdminUpdateShowTime = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`${server}/api/v1/admin/showtime/update`, userData, config);
...
export const AdminUpdateWinset = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`${server}/api/v1/admin/winset/update`, userData, config);
...
export const getShowtime = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${server}/api/v1/admin/getshowtime`);
...
export const AdminUpdateBetDone = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`${server}/api/v1/admin/bet/done`,  config);
...
export const UpdateNotifi = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`${server}/api/v1/me/notifi`,  config);
...
export const createShowhistory = (sayData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `${server}/api/v1/admin/showhistory`,
      sayData,
      config
    );
...
export const getAllShowHistory =() => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${server}/api/v1/user/showhistory`);
