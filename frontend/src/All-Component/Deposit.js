    ...
    {loading ? <Loader/> : (
        ...
        <form encType='multipart/from-data' onSubmit={depositSubmit} >
           ...
           <a href="https://p.paytm.me/xCTH/10y4qmr3">  <h6> Paytm Deposit Link </h6> </a>
            ...
            <label for="Name"> UPI Transaction ID / UPI Ref : No <span className={styles.Star}> *  </span> </label> <br/>       
            <input class="input-field" type="text" placeholder=" UPI ID: T2208020823094987772376 /    UPI Ref : No:221442702138" title=" Transaction ID / UTR " name="paymentId"  required value={paymentId} onChange={depositDataChange}  /> <br/>
